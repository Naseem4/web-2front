function WeeklyProgress({ data }) {
    // نحدد أعلى قيمة في البيانات لنحسب الارتفاع بدقة، أو نضع رقماً ثابتاً كهدف (Target)
    const maxValue = 800;
    ...
    return (
        <div style={{
            display: "flex",
            alignItems: "flex-end",
            height: "220px", // زدنا الارتفاع قليلاً لاستيعاب أسماء الأيام
            gap: "12px",
            marginTop: "30px",
            paddingBottom: "20px"
        }}>
            {data.map((v, i) => (
                <div key={i} style={{
                    ...
                    {/* قيمة السعرات تظهر فوق العمود عند الحاجة (اختياري) */}
                    ...
                    <div
                        style={{
                            ...
                            borderRadius: "8px",
                            transition: "height 0.8s ease-out", // أنيميشن عند تحميل الصفحة
                            cursor: "pointer",
